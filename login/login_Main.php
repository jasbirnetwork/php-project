...
<button  class="btn" "> <a href="Student_Registration.php">New User </a></button>
      
      
    <button  class="btn" value="Forget Password"> <a href="Student_forgot.php">Forget Password</a></button>
      
    <button  class="btn" value="Student Login"> <a href="Login_Teacher_Main.php">Teacher Login</a></button>
